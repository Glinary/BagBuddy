...
function validatePassword() {
    ...
    if (passwordlength < 7) {
        passwordFeedback.textContent = 'Invalid length of password. Must be at least 7 characters.';
...
document.getElementById('register-submit-btn').addEventListener('click', async function(event) {
    ...
    if (nameData.message === 'Name is valid.' && emailData.message === 'Email is valid.') {
        try {
